...
const WELCOME_MESSAGE = `Welcome to your private viewing of **42 Ironbark Ridge Road, Rouse Hill** — an architectural masterpiece in one of Sydney's most sought-after enclaves.

I'm your AI Property Concierge. Ask me anything about the home — from the kitchen specs to school catchments. I'm here to help.`;
        ...
        {leadCaptured && (
          <div className="mx-auto max-w-sm bg-emerald-500/10 border border-emerald-500/30 rounded-xl px-4 py-3 text-center">
            ...
            <div className="text-emerald-300/70 text-xs mt-1">
              Jag will be in touch to confirm your priority viewing
            </div>
          </div>
        )}
      ...
      <div className="border-t border-white/[0.06] bg-slate-950/80 backdrop-blur-sm px-4 sm:px-6 py-4">
        ...
        <div className="text-center mt-2">
          <span className="text-[11px] text-slate-600">
            Powered by Jag Singh AI — Private Real Estate Intelligence
          </span>
        </div>
      </div>
    </div>
